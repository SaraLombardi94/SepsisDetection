# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 12:39:54 2024
...
def get_model(model_name):
    models = {
        ...
        'random_forest': RandomForestClassifier (n_estimators=100, criterion='gini', max_depth=None, min_samples_split=2, min_samples_leaf=1, 
        ...
        'xgboost': XGBClassifier (n_estimators=100,learning_rate=0.1,max_depth=3,subsample=0.8, random_state=42)
    }
...
def train_and_evaluate_model(X_train, X_test, y_train, y_test, model_name):
    ...
    # Restituisci il modello e/o le metriche di valutazione se necessario
...
#### ADDESTRAMENTO DEL MODELLO ####
    ...
    y_pred_xgb = train_and_evaluate_model(X_train_std, X_test_std, y_train, y_test,'xgboost')
