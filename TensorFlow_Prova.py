...
MODELNAME = f'{K}fold_RS{RANDOM_STATE}_dsTM2min30_saraCnn1_mse_bs{BATCH_SIZE}_lre{LR}_windows{WINDOW_LENGTH}onset_jitter{USE_JITTER}_fft{USE_FFT}_scaling{USE_SCALING}_ep{EPOCHS}_bis'
...
def get_id(data_path):
  ...
  for item in data_path:
    file_name = item.split(os.path.sep)[-1].rstrip('.npy')
