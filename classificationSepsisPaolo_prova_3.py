# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 10:14:25 2024
...
# Definizione della nuova funzione per la scalatura standard delle features utile per il MLP (multi layer perceptron)
def standard_scale_features(train_set, test_set):
...
def perform_nested_cv(model_name, X_train, y_train):
    ...
    if model_name == 'random_forest':
        ...
        param_grid = {
            'hidden_layer_sizes': [(50,), (100,)],  # Esempi di configurazioni
